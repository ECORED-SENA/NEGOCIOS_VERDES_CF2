  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #MapaGroup01
      ...
      #collapse01.collapse.show(data-bs-parent='#MapaGroup01')
        .titulo-segundo
          #t_1_1.h2 1.1  Convenio de Diversidad Biológica o Convention on Biological Diversity
        .row.mb-5
      ...
      #collapse02.collapse(data-bs-parent='#MapaGroup01')
        ...
        .row
          ...
          .col-lg-8(data-aos="fade-down-right")
            p.mb-3 La Convención de las Naciones Unidas para combatir la Desertificación (UNCCD por sus sigla en inglés) es un acuerdo Internacional universal cuyo fin es promover una respuesta global para la desertificación. La Cumbre para la Tierra celebrada en Río de Janeiro en 1992, fue la génesis de esta Convención, la cual entró en vigor en 1996.
      ...
      #collapse06.collapse(data-bs-parent='#MapaGroup01')
        ...
        .row
          ...
          .col-lg-8
            ...
            .bloque-texto-c.color-acento-botones.p-4
              h1.fas.fa-quote-right.mb-0
              h3.mb-2 a misión de la UPOV es proporcionar y fomentar un sistema eficaz para la protección de las variedades vegetales, con miras al desarrollo de nuevas variedades vegetales para beneficio de la sociedad
              span - UPOV, 2020
