  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.p-5.justify-content-center.mb-5
      .col-lg-10
        ...
        .tarjeta.tarjeta--azul.bg06.p-4.mb-5(data-aos="slide-left")
          SlyderA
    ...
    p.mb-5(data-aos="zoom-in") Así mismo, para lograr un estudio detallado de cada uno de ellos, el IDEAM los ha clasificado en ocho temáticas diferentes: bosques y recursos forestal, agua, suelos y tierras, aire, cambio climático, residuos peligrosos y bifenilos policlorados - PCB, clima y ecosistemas. 
    ...
    .row.justify-content-center.mb-5(data-aos="slide-right")
      .col-lg-9.bor2.p-3
        p.mb-0.text-center Existen tres tipos de huella hídrica, los cuales depende de la procedencia del agua o el estado que tiene después de usarse: 
